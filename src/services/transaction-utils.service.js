...
import { Asset } from "../app/_classes/asset";
import { MidgardService } from "./midgard.service";
import { TxType } from "../app/swap/_const/tx-type";

export class TransactionUtilsService {
  _outboundTransactionFee;
  _ethPool;

  constructor(midgardService) {
