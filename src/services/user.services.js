...
//   let userSource;
  ...
  userBalancesSource = new BehaviorSubject(null);
  userBalances$ = this.userBalancesSource.asObservable();
//   let _balances;

  chainBalanceErrorsSource = new BehaviorSubject([]);
  chainBalanceErrors$ = this.chainBalanceErrorsSource.asObservable();
//   let _chainBalanceErrors;

  killRunePolling = new Subject();
...
//   asgardexBncClient: BinanceClient;
  ...
  getBinanceBalances =() =>  {
    try {
      ...
      const bncClient= await client.getBncClient();
  ...
  getEthereumBalances = (client, address) =>{
    try {
      // ETH
      const provider = client.getProvider();
      const ethBalance = await provider(address);
      this.pushBalances([
        {
   ...
   */
  pollNativeRuneBalance = (currentBalance) =>{
