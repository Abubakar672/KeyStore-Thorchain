...
var getSwapMemo = function (_a) {
    var _b;
    var asset = _a.asset, _c = _a.address, address = _c === void 0 ? '' : _c, limit = _a.limit;
    return "SWAP:" + assetToMemoString(asset) + ":" + address + ":" + ((_b = limit === null || limit === void 0 ? void 0 : limit.amount().toString()) !== null && _b !== void 0 ? _b : '');
};
/**
 * Memo to deposit
 *
 ...
 */
var getDepositMemo = function (asset, address) {
    if (address === void 0) { address = ''; }
    return "ADD:" + assetToMemoString(asset) + ":" + address;
};
/**
 * Memo to withdraw
 *
...
var getWithdrawMemo = function (_a) {
    var asset = _a.asset, percent = _a.percent, targetAsset = _a.targetAsset;
    var target = targetAsset ? ":" + assetToMemoString(targetAsset) : '';
 ...
 */
var getSwitchMemo = function (address) { return "SWITCH:" + address; };
/**
 * Memo to bond
 *
 ...
 */
var getBondMemo = function (thorAddress) { return "BOND:" + thorAddress; };
/**
 * Memo to unbond
 *
...
var getUnbondMemo = function (thorAddress, units) {
    return "UNBOND:" + thorAddress + ":" + units.amount().toString();
};
/**
 * Memo to leave
 *
 ...
 */
var getLeaveMemo = function (thorAddress) { return "LEAVE:" + thorAddress; };
