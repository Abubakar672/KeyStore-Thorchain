...
var Client = /** @class */ (function () {
    ...
    function Client(_a) {
        ...
        this.getAccount = function (address) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.bncClient.getAccount(address)];
        ...
        this.getPrivateKey = function () {
            if (!_this.privateKey) {
                if (!_this.phrase)
                    throw Error('Phrase has not been set before');
                var privateKey = crypto.getPrivateKeyFromMnemonic(_this.phrase);
        ...
        this.getAddress = function () {
            ...
            var address = crypto.getAddressFromPrivateKey(privateKey, _this.getPrefix()); // Extract address with prefix
        ...
        this.getBalance = function (address) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.bncClient.getBalance(address || this.getAddress() || undefined)];
                }
            });
        }); };
        ...
        this.vaultTx = function (_a) {
            var addressFrom = _a.addressFrom, addressTo = _a.addressTo, amount = _a.amount, asset = _a.asset, memo = _a.memo;
            return __awaiter(_this, void 0, void 0, function () {
                var from;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.sent();
                            return [4 /*yield*/, this.setPrivateKey().catch(function (error) { return Promise.reject(error); })];
                        case 2:
                            _b.sent();
                            from = addressFrom || this.getAddress();
                            if (!from)
                                return [2 /*return*/, Promise.reject(new Error('Parameter `addressFrom` has to be set. Or set a phrase by calling `setPhrase` before to use an address of an imported key.'))];
                            return [4 /*yield*/, this.bncClient.transfer(from, addressTo, amount, asset, memo)];
        ...
        this.normalTx = function (_a) {
            var addressFrom = _a.addressFrom, addressTo = _a.addressTo, amount = _a.amount, asset = _a.asset;
            return __awaiter(_this, void 0, void 0, function () {
                var from;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            if (!from)
                                return [2 /*return*/, Promise.reject(new Error('Parameter `addressFrom` has to be set. Or set a phrase by calling `setPhrase` before to use an address of an imported key.'))];
                            return [4 /*yield*/, this.bncClient.transfer(from, addressTo, amount, asset)];
                        case 3: return [2 /*return*/, _b.sent()];
                    }
                });
            });
        ...
        this.freeze = function (_a) {
            var address = _a.address, asset = _a.asset, amount = _a.amount;
            return __awaiter(_this, void 0, void 0, function () {
                var addr;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this.bncClient.tokens.freeze(addr, asset, amount)];
                        case 3: return [2 /*return*/, _b.sent()];
                    }
                });
            });
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            if (!addr)
                                return [2 /*return*/, Promise.reject(new Error('Address has to be set. Or set a phrase by calling `setPhrase` before to use an address of an imported key.'))];
                            return [4 /*yield*/, this.bncClient.tokens.unfreeze(addr, asset, amount)];
                        case 3: return [2 /*return*/, _b.sent()];
                    }
                });
            });
        };
        this.getMarkets = function (_a) {
            var _b = _a.limit, limit = _b === void 0 ? 1000 : _b, _c = _a.offset, offset = _c === void 0 ? 0 : _c;
            return __awaiter(_this, void 0, void 0, function () {
...
export { Client, OrderStatus, binanceWs as WS, getHashFromTransfer, getTxHashFromMemo, isDexFees, isFee, isTransferFee };
