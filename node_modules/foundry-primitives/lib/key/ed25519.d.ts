 ...
 */
export declare const signEd25519: (message: string, priv: string) => string;
/**
 ...
 */
export declare const verifyEd25519: (message: string, signature: string, pub: string) => boolean;
