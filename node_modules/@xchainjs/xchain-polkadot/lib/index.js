...
var AssetDOT = { chain: xchainUtil.Chain.Polkadot, symbol: 'DOT', ticker: 'DOT' };
...
var getDefaultFees = function (network) {
    var fee = xchainUtil.assetToBase(xchainUtil.assetAmount(0.015, getDecimal(network)));
    return xchainClient.singleFee(xchainClient.FeeType.PerByte, fee);
};
/**
...
var Client = /** @class */ (function () {
    ...
    function Client(_a) {
        ...
        var _c = _a.network, network = _c === void 0 ? xchainClient.Network.Testnet : _c, phrase = _a.phrase, _d = _a.rootDerivationPaths, rootDerivationPaths = _d === void 0 ? (_b = {},
            _b[xchainClient.Network.Mainnet] = "44//354//0//0//0'",
            _b[xchainClient.Network.Testnet] = "44//354//0//0//0'",
            _b) : _d;
        this.phrase = '';
    ...
    Client.prototype.getKeyringPair = function (index) {
        var key = new api.Keyring({ ss58Format: this.getSS58Format(), type: 'ed25519' });
    ...
    Client.prototype.getAPI = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        api$1 = new api.ApiPromise({ provider: new api.WsProvider(this.getWsEndpoint()) });
                        return [4 /*yield*/, api$1.isReady];
                    case 1:
                        _a.sent();
                        if (!!api$1.isConnected) return [3 /*break*/, 3];
                        return [4 /*yield*/, api$1.connect()];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [2 /*return*/, api$1];
                }
            });
        });
    };
    ...
    Client.prototype.validateAddress = function (address) {
        try {
            var key = new api.Keyring({ ss58Format: this.getSS58Format(), type: 'ed25519' });
            return key.encodeAddress(util.isHex(address) ? util.hexToU8a(address) : key.decodeAddress(address)) === address;
        }
        catch (error) {
            return false;
        }
    ...
    Client.prototype.getBalance = function (address, assets) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios__default['default'].post(this.getClientUrl() + "/api/open/account", { address: address || this.getAddress() })];
                    case 1:
                        response = (_a.sent()).data;
                        if (!isSuccess(response))
                            throw new Error('Invalid address');
                        account = response.data;
                        return [2 /*return*/, account && (!assets || assets.filter(function (asset) { return xchainUtil.assetToString(AssetDOT) === xchainUtil.assetToString(asset); }).length)
                                ? [
                                    {
                                        asset: AssetDOT,
                                        amount: xchainUtil.assetToBase(xchainUtil.assetAmount(account.balance, getDecimal(this.network))),
                                    },
                                ]
                                : []];
                }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios__default['default'].post(this.getClientUrl() + "/api/scan/transfers", {
                        ...
                        return [2 /*return*/, {
                                ...
                                txs: (transferResult.transfers || []).map(function (transfer) { return ({
                                    ...
                                    from: [
                                        {
                                            from: transfer.from,
                                            amount: xchainUtil.assetToBase(xchainUtil.assetAmount(transfer.amount, getDecimal(_this.network))),
                                        },
                                    ],
                                    to: [
                                        {
    ...
    Client.prototype.getTransactionData = function (txId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios__default['default'].post(this.getClientUrl() + "/api/scan/extrinsic", { hash: txId })];
                    case 1:
                        response = (_a.sent()).data;
                        if (!isSuccess(response) || !response.data)
                            throw new Error('Failed to get transactions');
                        ...
                        return [2 /*return*/, {
                                ...
                                from: [
                                    {
                                        from: transfer.from,
                                        amount: xchainUtil.assetToBase(xchainUtil.assetAmount(transfer.amount, getDecimal(this.network))),
                                    },
                                ],
                                to: [
                                    {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        paymentInfo = _a.sent();
                        fee = xchainUtil.baseAmount(paymentInfo.partialFee.toString(), getDecimal(this.network));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        info = _a.sent();
                        fee = xchainUtil.baseAmount(info.partialFee.toString(), getDecimal(this.network));
                        return [4 /*yield*/, api.disconnect()];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, xchainClient.singleFee(xchainClient.FeeType.PerByte, fee)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.estimateFees({
                            ...
                            amount: xchainUtil.baseAmount(0, getDecimal(this.network)),
                        })];
