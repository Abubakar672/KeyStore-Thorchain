...
export declare type LitecoinClientParams = XChainClientParams & {
    sochainUrl?: string;
    nodeUrl?: string;
...
declare class Client extends UTXOClient {
     ...
     */
    constructor({ network, sochainUrl, phrase, nodeUrl, nodeAuth, rootDerivationPaths, }: LitecoinClientParams);
    /**
