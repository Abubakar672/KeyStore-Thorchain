...
- transfer method of xchain-bitcoincache client is not able sign list of utxos because some of them were filtered by buildTx, as the result No input at index: X exception is thrown.
