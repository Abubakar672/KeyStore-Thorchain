...
var AssetAtom = { chain: xchainUtil.Chain.Cosmos, symbol: 'ATOM', ticker: 'ATOM' };
var AssetMuon = { chain: xchainUtil.Chain.Cosmos, symbol: 'MUON', ticker: 'MUON' };
        ...
        return __spreadArray(__spreadArray([], acc), [
            {
                ...
                type: from.length > 0 || to.length > 0 ? xchainClient.TxType.Transfer : xchainClient.TxType.Unknown,
                hash: tx.txhash || '',
            },
        ]);
    }, []);
...
var CosmosSDKClient = /** @class */ (function () {
    ...
    CosmosSDKClient.prototype.updatePrefix = function (prefix) {
        this.prefix = prefix;
        this.setPrefix();
    };
    CosmosSDKClient.prototype.setPrefix = function () {
        cosmosClient.AccAddress.setBech32Prefix(this.prefix, this.prefix + 'pub', this.prefix + 'valoper', this.prefix + 'valoperpub', this.prefix + 'valcons', this.prefix + 'valconspub');
    };
    CosmosSDKClient.prototype.getAddressFromPrivKey = function (privkey) {
        this.setPrefix();
        return cosmosClient.AccAddress.fromPublicKey(privkey.getPubKey()).toBech32();
    };
    CosmosSDKClient.prototype.getAddressFromMnemonic = function (mnemonic, derivationPath) {
        this.setPrefix();
        var privKey = this.getPrivKeyFromMnemonic(mnemonic, derivationPath);
        return cosmosClient.AccAddress.fromPublicKey(privKey.getPubKey()).toBech32();
    };
    CosmosSDKClient.prototype.getPrivKeyFromMnemonic = function (mnemonic, derivationPath) {
    ...
    CosmosSDKClient.prototype.checkAddress = function (address) {
        this.setPrefix();
    ...
    CosmosSDKClient.prototype.getBalance = function (address) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, bank.bank.balancesAddressGet(this.sdk, accAddress)];
                    case 1: return [2 /*return*/, (_a.sent()).data.result];
                }
            });
        });
    };
    CosmosSDKClient.prototype.searchTx = function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this.setPrefix();
                        return [4 /*yield*/, axios__default['default'].get(this.server + "/txs?" + getQueryString(queryParameter))];
                    case 1: return [2 /*return*/, (_b.sent()).data];
                }
            });
        });
    };
    CosmosSDKClient.prototype.searchTxFromRPC = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var queryParameter, searchParameter, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        queryParameter = [];
                        ...
                        return [4 /*yield*/, axios__default['default'].get(rpcEndpoint + "/tx_search?" + searchParameter.join('&'))];
                    case 1:
    ...
    CosmosSDKClient.prototype.txsHashGet = function (hash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.setPrefix();
                        return [4 /*yield*/, axios__default['default'].get(this.server + "/txs/" + hash)];
                    case 1: return [2 /*return*/, (_a.sent()).data];
                }
            });
        });
    };
    CosmosSDKClient.prototype.transfer = function (_a) {
    ...
    CosmosSDKClient.prototype.signAndBroadcast = function (unsignedStdTx, privkey, signer) {
        return __awaiter(this, void 0, void 0, function () {
            var account, signedStdTx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.setPrefix();
                        return [4 /*yield*/, auth.auth.accountsAddressGet(this.sdk, signer)];
                    case 1:
                        account = (_a.sent()).data.result;
                        ...
                        return [4 /*yield*/, auth.auth.txsPost(this.sdk, signedStdTx, 'block')];
...
var Client = /** @class */ (function () {
    ...
    function Client(_a) {
        var _b;
        var _c = _a.network, network = _c === void 0 ? xchainClient.Network.Testnet : _c, phrase = _a.phrase, _d = _a.rootDerivationPaths, rootDerivationPaths = _d === void 0 ? (_b = {},
            _b[xchainClient.Network.Mainnet] = "44'/118'/0'/0/",
            _b[xchainClient.Network.Testnet] = "44'/118'/1'/0/",
            _b) : _d;
        this.phrase = '';
        this.sdkClients = new Map();
        this.network = network;
        this.rootDerivationPaths = rootDerivationPaths;
        this.sdkClients.set(xchainClient.Network.Testnet, TESTNET_SDK);
        this.sdkClients.set(xchainClient.Network.Mainnet, MAINNET_SDK);
        if (phrase)
    ...
    Client.prototype.getSDKClient = function () {
     ...
     */
    Client.prototype.getMainAsset = function () {
        switch (this.network) {
            case xchainClient.Network.Mainnet:
                return AssetAtom;
            case xchainClient.Network.Testnet:
    ...
    Client.prototype.getBalance = function (address, assets) {
        return __awaiter(this, void 0, void 0, function () {
            var balances, mainAsset;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getSDKClient().getBalance(address)];
                    case 1:
                        balances = _a.sent();
    ...
    Client.prototype.getTransactions = function (params) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var messageAction, page, limit, txMinHeight, txMaxHeight, mainAsset, txHistory;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    Client.prototype.getTransactionData = function (txId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getSDKClient().txsHashGet(txId)];
                    case 1:
                        txResult = _a.sent();
    ...
    Client.prototype.transfer = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var fromAddressIndex, mainAsset, transferResult;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
