 ...
 * @param {number} decimal as AssetssThe decimal places. (optional)
...
/**
 * Helper to convert values for a asset from base values (e.g. RUNE from tor)AssetETH
 ...
 *
 * @param {Amount<DenominAssetETHset;
    amount: () => BigNumber;
 ...
 *
 * @see  https://docs.thorchain.org/developers/transactformatBaseAsAssetAmountg.
 */
