 ...
 */
export declare type TickerStatistics = {
    /**
     * sell price
     */
    askPrice: string;
...
export declare type Fees = (Fee | TransferFee | DexFees)[];
/**
 * Tx
...
export declare type VaultTxParams = {
    addressFrom?: Address;
    addressTo: Address;
    amount: BigSource;
    asset: string;
...
export declare type GetMarketsParams = {
    limit?: number;
    offset?: number;
};
/**
...
export declare type StdTransaction = {
