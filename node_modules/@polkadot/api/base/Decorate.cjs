...
class Decorate extends _Events.Events {
  ...
  _decorateStorageEntry(creator, decorateMethod) {
    ...
    decorated.at = decorateMethod((hash, ...args) => (0, _rxjs.from)(this.at(hash)).pipe((0, _rxjs.switchMap)(api => {
      (0, _util.assert)(api.rx.query[creator.section] && api.rx.query[creator.section][creator.method], () => `query.${creator.section}.${creator.method} is not available in this version of the metadata`);
